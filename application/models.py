...
class JobApp(models.Model):
    ...
    (9, 'إب'), (10, 'مأرب'), (12, 'صعدة'),
     (14, 'تعز'), (15, 'عدن'), (16, 'أبين'), (18, 'المهرة'), (19, 'حضرموت'),
...
class Inqueries(models.Model):
    ...
    inq_loan=models.CharField(max_length=20,null=True,verbose_name=u"هل عليك قروض أو ديون أو مشاكل مادية", choices=yn_choices)
    inq_training=models.CharField(max_length=20,null=True,verbose_name=u"هل ترغب في الحصول على دورات تدريبية في مجال عملك", choices=yn_choices_2)
    ...
    inq_long_term_disease=models.CharField(max_length=200,null=True,verbose_name=u"هل تعاني من أي مشاكل صحية أو نفسية أو أمراض مزمنة",choices=yn_choices )
    ...
    inq_surgery=models.CharField(max_length=200,null=True,verbose_name=u"هل سبق ان أجريت لك أي عملية جراحية",choices=yn_choices  )
    inq_surgery_detail=models.CharField(max_length=200,null=True,default="",verbose_name=u"عند الإجابة بنعم - نرجو تحديدها",blank=True ,)
    inq_cust_contact=models.CharField(max_length=20,null=True,verbose_name=u"هل سبق وكانت طبيعة عملك تتطلب التعامل مع العملاء؟",choices=yn_choices )
    inq_favor_w_place=models.IntegerField(verbose_name=u"ماهي المحافظة التي تفضل العمل فيها، بحكم تواجد السكن الأصلي لك؟" , choices=city_options )
    inq_accept_w_place=models.CharField(max_length=200,null=True,verbose_name=u"وهل تقبل العمل في محافظة إذا طلب منك ذلك", choices=yn_choices )
    inq_explain=models.TextField(max_length=200,verbose_name=u"لماذا ترغب في العمل لدى البنك المركزي اليمني؟")
    job = models.ForeignKey(JobApp, on_delete=models.CASCADE,default="" )
